...
interface Recorder {
  fun start(name: String, recordAudio: Boolean, callback: (Result<Boolean>) -> Unit)
  fun stop(callback: (Result<String>) -> Unit)

  companion object {
    /** The codec used by Recorder. */
    val codec: MessageCodec<Any?> by lazy {
      StandardMessageCodec()
    }
    /** Sets up an instance of `Recorder` to handle messages through the `binaryMessenger`. */
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.start(nameArg, recordAudioArg) { result: Result<Boolean> ->
